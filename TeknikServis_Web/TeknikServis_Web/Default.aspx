...
<body>
    <div class="sidenav">
        <div class="row side_top">
            <div class="col-4 side_top_left">
                <img src="web/images/cmplogo.png" alt="news image" class="img-fluid navimg">
            </div>
    ...
    <div class="main" id="home">
        <div class="banner-text-w3ls">
            <div class="container">
                <div class="mx-auto text-center">
                    ...
                    <p class="banp mx-auto mt-3">24 farklı kategori de yüzlerce ürünle sizlerleyiz.  </p>
        ...
        <section class="slide-wrapper" id="about">
            ...
            <img src="web/images/about-us.png" class="img-fluid" alt="">
            <p class="iner mt-5">
        ...
        <div class="wthree_pvtits-services align-w3" id="services">
            <div class="container">
                <div class="wthree_pvt_title text-center">
                    ...
                    <p class="main_p mb-5  text-center mx-auto">Mağazamızdan almış olduğunuz ürünlerde herhangi bir teknik problem oluşursa 
                        2 yıl süreyle herhnagi bir ücret ödemeden tamir ve onarım işlemlerini yapmaktayız.
                    </p>
                    <a class="btn btn-primary mt-lg-5 mt-3 agile-link-bnr" style="background-color:lightcoral" href="WebForm1.aspx" role="button">Arızalı Ürün Takibi</a>
                </div>
                <div class="wthree_pvtits-services-row row">
                    ...
                    <div class="col-lg-4 col-md-6  wthree_sgrid  py-sm-5 py-4">
                        ...
                        <h4 class="my-3">Yüzde 99 Memnuniyet</h4>
                    </div>
                    <div class="col-lg-4 col-md-6  wthree_sgrid   py-sm-5 py-4">
        ...
        <section class="wedo" id="contact">
            ...
            <p class="main_p mb-5  text-center mx-auto">Mağazamız ya da aldığınız herhangi bir ürüne dair sorun oluşursa bize aşağıdaki panelden 
                mail atarak ulaşabilirsiniz.Mailinize en kısa sürede dönüş yapılacaktır.
            </p>
            ...
            <div class="cpy-right text-center">
                <div class="follow">
                    <ul class="social_section_1info">
                        ...
                        <li><a href="https://tr.wikipedia.org/wiki/Google%2B"><span class="fa fa-google-plus"></span></a></li>
                        <li><a href="https://dribbble.com/"><span class="fa fa-dribbble"></span></a></li>

                        <li><a href="https://vimeo.com/"><span class="fa fa-vimeo"></span></a></li>
                        <li><a href="https://www.linkedin.com/feed/?trk=homepage-basic_google-one-tap-submit"><span class="fa fa-linkedin"></span></a></li>
                    </ul>
                </div>
                <p>
                    © 2021 Teknik Servis ve Ürün Takip Servisi | Tüm hakları saklıdır. |
					<a href="https://github.com/elifercann">Elif ERCAN </a>
                </p>
            </div>
        </section>
        <!-- //contact -->
